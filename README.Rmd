...
This repository contains code, data, and documentation for the Cook County Assessor's 2023 condominium reassessment model. Information about prior year models can be found at the following links:
