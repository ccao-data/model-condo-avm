...
| 2025 | North | County-wide LightGBM model | R (Tidyverse / Tidymodels) |  |

[Link](https://github.com/ccao-data/model-condo-avm/tree/2025-assessment-year)
...
time-weighted, rolling average building-level sale price for each sale.
In layman’s terms, we take the average of the sales in the same building
...
- [assessment_data.parquet](https://ccao-data-public-us-east-1.s3.amazonaws.com/models/inputs/condo/2026/assessment_data.parquet)
- [char_data.parquet](https://ccao-data-public-us-east-1.s3.amazonaws.com/models/inputs/condo/2026/char_data.parquet)
- [land_nbhd_rate_data.parquet](https://ccao-data-public-us-east-1.s3.amazonaws.com/models/inputs/condo/2026/land_nbhd_rate_data.parquet)
- [training_data.parquet](https://ccao-data-public-us-east-1.s3.amazonaws.com/models/inputs/condo/2026/training_data.parquet)
