...
model_ratio_distribution_main <- model_ratio_distribution_df %>%
  filter(stage == "Main Model") %>%
  arrange(quantile)
model_ratio_distribution_breaks <- model_ratio_distribution_main$quantile
model_ratio_distribution_labels <- model_ratio_distribution_main$custom_label
...
model_ratio_distribution_triad_plot <- ggplot(
  ...
  scale_x_continuous(breaks = model_ratio_distribution_breaks, labels = model_ratio_distribution_labels) +
  scale_color_manual(
    values = c(
...
generate_model_ratio_township_graph <- function(data, township, lims) {
  ...
  ggplot(
    ...
    scale_x_continuous(breaks = data_to_plot_breaks, labels = data_to_plot_labels) +
    scale_color_manual(
      values = c(
        "Main Model" = plot_colors$main,
        "Linear Baseline" = plot_colors$linear
