...
training_data_outlier_analysis <-
  ...
  mutate(
    sv_outlier_reason_simplified = case_when(
      ...
      str_detect(sv_outlier_reason, "Review: Non-Arms-Length") &
        str_detect(sv_outlier_reason, "Algorithm: Low price") ~
        "Review: Non-Arms-Length, Algorithm: Low price",
      str_detect(sv_outlier_reason, "Review: Non-Arms-Length") &
        str_detect(sv_outlier_reason, "Algorithm: High price") ~
        "Review: Non-Arms-Length, Algorithm: High price",
      # Review Flip + algorithm price
      str_detect(sv_outlier_reason, "Review: Flip") &
        str_detect(sv_outlier_reason, "Algorithm: Low price") ~
        "Review: Flip, Algorithm: Low price",
      str_detect(sv_outlier_reason, "Review: Flip") &
        str_detect(sv_outlier_reason, "Algorithm: High price") ~
        "Review: Flip, Algorithm: High price",
      # Algorithm-only or review-only reasons
      str_detect(sv_outlier_reason, "High price") &
        str_detect(sv_outlier_reason, "PTAX-203 Exclusion") ~
      ...
      str_detect(sv_outlier_reason, "Non-livable area") ~
        "Non-livable area",
